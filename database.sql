...
CREATE TABLE IF NOT EXISTS `bantuan` (
  `jenis_bantuan` int(11) NOT NULL AUTO_INCREMENT,
  `nama` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`jenis_bantuan`)
...
INSERT INTO `bantuan` (`jenis_bantuan`, `nama`) VALUES
(1, 'bantuan PPA'),
(2, 'bantuan BBP PPA'),
(3, 'bantuan BIDIKMISI'),
(4, 'bantuan DIKPORA'),
...
CREATE TABLE IF NOT EXISTS `hasil` (
  ...
  `jenis_bantuan` int(11) NOT NULL,
  `NIK` char(23) NOT NULL,
  `nilai` float DEFAULT NULL,
  `tahun` char(4) DEFAULT NULL,
  PRIMARY KEY (`kd_hasil`),
  KEY `fk_keluarga` (`NIK`),
  KEY `fk_bantuan` (`jenis_bantuan`)
...
INSERT INTO `hasil` (`kd_hasil`, `jenis_bantuan`, `NIK`, `nilai`, `tahun`) VALUES
...
CREATE TABLE IF NOT EXISTS `kriteria` (
  ...
  KEY `jenis_bantuan` (`jenis_bantuan`),
  KEY `jenis_bantuan_2` (`jenis_bantuan`)
...
INSERT INTO `kriteria` (`kd_kriteria`, `jenis_bantuan`, `nama`, `sifat`) VALUES
(1, 1, 'IPK', 'max'),
(2, 1, 'Semester', 'max'),
...
INSERT INTO `keluarga` (`NIK`, `nama`, `alamat`, `jenis_kelamin`, `tahun_mengajukan`) VALUES
...
INSERT INTO `model` (`kd_model`, `jenis_bantuan`, `kd_kriteria`, `bobot`) VALUES
(1, 1, 1, '0.50'),
(2, 1, 2, '0.20'),
(3, 1, 3, '0.30'),
(4, 2, 4, '0.40'),
...
CREATE TABLE IF NOT EXISTS `nilai` (
  ...
  `jenis_bantuan` int(11) DEFAULT NULL,
  `kd_kriteria` int(11) NOT NULL,
  `NIK` char(23) NOT NULL,
  `nilai` float DEFAULT NULL,
...
INSERT INTO `nilai` (`kd_nilai`, `jenis_bantuan`, `kd_kriteria`, `NIK`, `nilai`) VALUES
(1, 1, 1, '125610036', 2),
(2, 1, 2, '125610036', 3),
(3, 1, 3, '125610036', 2),
(4, 1, 1, '125610080', 1),
...
CREATE TABLE IF NOT EXISTS `pengguna` (
  ...
  `status` enum('petugas','puket','keluarga') DEFAULT NULL,
...
INSERT INTO `penilaian` (`kd_penilaian`, `jenis_bantuan`, `kd_kriteria`, `keterangan`, `bobot`) VALUES
(1, 1, 1, '3.00 - 3.20', 1),
(2, 1, 1, '3.21 - 3.40', 2),
(3, 1, 1, '3.41 - 3.40', 3),
(4, 1, 1, '>= 3.61', 4),
...
--
ALTER TABLE `hasil`
  ADD CONSTRAINT `hasil_ibfk_1` FOREIGN KEY (`NIK`) REFERENCES `keluarga` (`NIK`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `hasil_ibfk_2` FOREIGN KEY (`jenis_bantuan`) REFERENCES `bantuan` (`jenis_bantuan`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `kriteria`
--
ALTER TABLE `kriteria`
  ADD CONSTRAINT `fk_bantuan` FOREIGN KEY (`jenis_bantuan`) REFERENCES `bantuan` (`jenis_bantuan`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `model`
  ...
  ADD CONSTRAINT `model_ibfk_2` FOREIGN KEY (`jenis_bantuan`) REFERENCES `bantuan` (`jenis_bantuan`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `nilai`
  ...
  ADD CONSTRAINT `nilai_ibfk_2` FOREIGN KEY (`NIK`) REFERENCES `keluarga` (`NIK`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `nilai_ibfk_3` FOREIGN KEY (`jenis_bantuan`) REFERENCES `bantuan` (`jenis_bantuan`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `penilaian`
  ...
  ADD CONSTRAINT `penilaian_ibfk_2` FOREIGN KEY (`jenis_bantuan`) REFERENCES `bantuan` (`jenis_bantuan`) ON DELETE CASCADE ON UPDATE CASCADE;
